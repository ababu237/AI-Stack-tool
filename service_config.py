...
BACKEND_SERVICES = {
    "clinical_chat": os.getenv("CLINICAL_CHAT_BACKEND", "http://localhost:8010"),
    "document": os.getenv("DOCUMENT_BACKEND", "http://localhost:8002"),
    "csv": os.getenv("CSV_BACKEND", "http://localhost:8003"),
    "organ": os.getenv("ORGAN_BACKEND", "http://localhost:8004"),
    "transcription": os.getenv("TRANSCRIPTION_BACKEND", "http://localhost:8005"),
    "translation": os.getenv("TRANSLATION_BACKEND", "http://localhost:8006"),
}
